...
function NavBar({ logout }) {
  return (
    <Stack direction="horizontal" gap={3} style={{ backgroundColor: "skyblue", justifyContent: "space-between", borderBottom: "2px solid black", paddingLeft: "10px", paddingRight: "10px" }}>
      ...
      <NavLink className="btn btn-outline-dark btn-sm" to="/submit">Submit Lyrics</NavLink>
